...
public class PhongMaterial extends AbstractMaterial {
    ...
    public static final int SIZEOF = 4 * VECTOR4_SIZEOF + 6 * SAMPLER_SIZEOF + VECTOR2_SIZEOF + 4 * FLOAT32_SIZEOF + INT32_SIZEOF;
    ...
    public PhongMaterial(String name, int handle) {
        super(name, handle);
        setupDefaults();
    }
