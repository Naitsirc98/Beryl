...
public final class TerrainMeshManager {

    // TODO: Handle resizing, destruction leaks and concurrent access

    private static final int VERTEX_BUFFER_INITIAL_CAPACITY = 1024 * 1024; // 4MB
    ...
    TerrainMesh create(int handle, String name, ByteBuffer vertices, ByteBuffer indices, float[][] heightMap, float minY, float maxY) {

        TerrainMesh mesh = new TerrainMesh(handle, name, vertices, indices, heightMap, minY, maxY);
    ...
    private void copyVertexData(TerrainMesh mesh) {
    ...
    private void copyIndexData(TerrainMesh mesh) {
    ...
    private void copyBoundingSphereData(TerrainMesh mesh) {
    ...
    private void copyCommandInfo(TerrainMesh mesh) {
    ...
    private void checkBuffers(TerrainMesh mesh) {
