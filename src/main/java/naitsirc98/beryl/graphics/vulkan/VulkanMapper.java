...
public class VulkanMapper extends GraphicsMapper {
    ...
    private void initPixelFormatMapper() {
        ...
        map.put(PixelFormat.RED, VK_FORMAT_R8_UINT);
        map.put(PixelFormat.RG, VK_FORMAT_R8G8_UINT);
        map.put(PixelFormat.RGB, VK_FORMAT_R8G8B8_UINT);
        map.put(PixelFormat.RGBA, VK_FORMAT_R8G8B8A8_UINT);

        map.put(PixelFormat.RED16F, VK_FORMAT_R16_UINT);
        map.put(PixelFormat.RG16F, VK_FORMAT_R16G16_UINT);
        map.put(PixelFormat.RGB16F, VK_FORMAT_R16G16B16_UINT);
        map.put(PixelFormat.RGBA16F, VK_FORMAT_R16G16B16A16_UINT);

        map.put(PixelFormat.RED32F, VK_FORMAT_R32_UINT);
        map.put(PixelFormat.RG32F, VK_FORMAT_R32G32_UINT);
        map.put(PixelFormat.RGB32F, VK_FORMAT_R32G32B32_UINT);
        map.put(PixelFormat.RGBA32F, VK_FORMAT_R32G32B32A32_UINT);
