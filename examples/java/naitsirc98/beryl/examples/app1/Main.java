...
public class Main {
    ...
    // Vertex shader
    private static final String VERT_SRC = "#version 450 core\n"
    ...
    // Fragment shader
    private static final String FRAG_SRC = "#version 450 core\n"
            + "out vec4 FragColor;\n"
            + "void main()\n"
            + "{\n"
    ...
    public static void main(String[] args) {
        ...
        final int vao = glCreateVertexArrays();
        final int vbo = glCreateBuffers();
